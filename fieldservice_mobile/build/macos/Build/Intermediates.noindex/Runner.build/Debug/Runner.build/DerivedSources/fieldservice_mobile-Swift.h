...
#ifndef FIELDSERVICE_MOBILE_SWIFT_H
#define FIELDSERVICE_MOBILE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="fieldservice_mobile",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC19fieldservice_mobile11AppDelegate")
...
SWIFT_CLASS("_TtC19fieldservice_mobile17MainFlutterWindow")
